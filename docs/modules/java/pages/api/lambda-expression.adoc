...
NOTE: In
{java-api-spec-url}/java.base/java/util/Collection.html#equals(java.lang.Object)[`⚪ Collection<E>`^]
...
{java-api-spec-url}/java.base/java/lang/FunctionalInterface.html[`@FunctionalInterface`^]
...
The
{java-api-spec-url}/java.base/java/util/function/package-summary.html[`java.util.function`^]
