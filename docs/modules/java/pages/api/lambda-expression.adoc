...
* Default methods
* Static methods
* {java-api-spec-url}/java.base/java/lang/Object.html[`🟢 Object`^] methods

NOTE: In {java-api-spec-url}/java.base/java/util/Collection.html#equals(java.lang.Object)[`⚪ Collection<E>`^] you may find `🟢 Object` methods which are changing the documentation of those methods. However, `⚪ Collection<E>` itself is not a Functional Interface as it has many abstract methods.
...
Functional Interface *may be annotated* with the special annotation called {java-api-spec-url}/java.base/java/lang/FunctionalInterface.html[`@FunctionalInterface`^], but it's *not mandatory*. This is for backward compatibility (e.g. since `@FunctionalInterface` is optional, {java-api-spec-url}/java.base/java/lang/Runnable.html[`⚪ Runnable`^] can be a Functional Interface).
...
The {java-api-spec-url}/java.base/java/util/function/package-summary.html[`java.util.function`^] package is organized in *4* categories:

* {java-api-spec-url}/java.base/java/util/function/Supplier.html[⚪ *Suppliers<T>*^] - do not take any argument and return an object of `T` type. Supplier is used in the {java-api-spec-url}/java.base/java/util/stream/Stream.html#generate(java.util.function.Supplier)[`generate`^] operation of the Stream API
+
[,java]
----
...
----
* {java-api-spec-url}/java.base/java/util/function/Consumer.html[⚪ *Consumers<T>*^] - consume an object of `T` type and do not return anything. Consumer is used in the {java-api-spec-url}/java.base/java/util/stream/Stream.html#forEach(java.util.function.Consumer)[`forEach`^] operation of the Stream API
+
[,java]
----
...
----
* {java-api-spec-url}/java.base/java/util/function/Predicate.html[⚪ *Predicates<T>*^] - take an object of `T` type, test it and return `boolean`. Predicate is used in the {java-api-spec-url}/java.base/java/util/stream/Stream.html#filter(java.util.function.Predicate)[`filter`^] operation of the Stream API
+
[,java]
----
...
----
* {java-api-spec-url}/java.base/java/util/function/Function.html[⚪ *Functions<T, R>*^] - take an object of `T` type and return an object of `R` type. Function is used in the {java-api-spec-url}/java.base/java/util/stream/Stream.html#map(java.util.function.Function)[`map`^] operation of the Stream API
+
[,java]
----
...
* {java-api-spec-url}/java.base/java/lang/Runnable.html[`⚪ Runnable`^] - does not take any argument and does not return anything. Defined to model task in Java concurrent programming
+
[,java]
----
...
----
* {java-api-spec-url}/java.base/java/util/Comparator.html[`⚪ Comparator<T>`^] - takes two objects of `T` type, compares them and returns `int`. A comparison function, which imposes a total ordering on some collection of objects
+
[,java]
----
...
Another example would be the creation of {java-api-spec-url}/java.base/java/util/Comparator.html[`⚪ Comparator<T>`^] for the following list:
