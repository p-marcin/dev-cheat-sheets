...
image:https://img.shields.io/badge/Spring%20Documentation-2088E9?logo=quickLook&logoColor[link="{spring-security-docs}/servlet/oauth2/resource-server/index.html",window=_blank]
image:https://img.shields.io/badge/Spring%20Boot%20Documentation-2088E9?logo=quickLook&logoColor[link="{spring-boot-docs}/reference/web/spring-security.html#web.security.oauth2.server",window=_blank]
