...
image:https://img.shields.io/badge/Spring%20Documentation-2088E9?logo=quickLook&logoColor[link="{spring-framework-docs}/web/webflux.html",window=_blank]
image:https://img.shields.io/badge/Spring%20Boot%20%20Documentation-2088E9?logo=quickLook&logoColor[link="{spring-boot-docs}/reference/web/reactive.html#web.reactive.webflux",window=_blank]
image:https://img.shields.io/badge/Reactor%20Core%20Documentation-2088E9?logo=quickLook&logoColor[link="{reactor-core-docs}",window=_blank]
...
image:https://img.shields.io/badge/Reactor%20Test%20Documentation-2088E9?logo=quickLook&logoColor[link="{reactor-core-docs}/testing.html",window=_blank]
