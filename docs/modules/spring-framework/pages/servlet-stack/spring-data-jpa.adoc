...
{spring-data-commons-api-spec-url}/org/springframework/data/repository/CrudRepository.html[`⚪ CrudRepository<T,ID>`^]::
...
{spring-data-commons-api-spec-url}/org/springframework/data/repository/ListCrudRepository.html[`⚪ ListCrudRepository<T,ID>`^]::
Extension to `⚪ CrudRepository<T,ID>` returning `⚪ List` instead of `⚪ Iterable` where applicable.

{spring-data-commons-api-spec-url}/org/springframework/data/repository/PagingAndSortingRepository.html[`⚪ PagingAndSortingRepository<T,ID>`^]::
...
{spring-data-commons-api-spec-url}/org/springframework/data/repository/ListPagingAndSortingRepository.html[`⚪ ListPagingAndSortingRepository<T,ID>`^]::
