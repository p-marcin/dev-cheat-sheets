...
image:https://img.shields.io/badge/Spring%20Documentation-2088E9?logo=quickLook&logoColor[link="{spring-framework-docs}/web/webmvc.html",window=_blank]
image:https://img.shields.io/badge/Spring%20Boot%20Documentation-2088E9?logo=quickLook&logoColor[link="{spring-boot-docs}/reference/web/servlet.html#web.servlet.spring-mvc",window=_blank]
